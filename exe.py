...
class Boutons :
	...
	def __init__(self, master):
		...
		self.tempe1 = Label(root, text="fait chaud ", font=police, anchor=E)
		self.tempe1.grid(row=0, column=2, padx=20, sticky=S+E)
		self.tempe2 = Label(root, text="actuellement :", font=police, anchor=E)
		self.tempe2.grid(row=1, column=2,padx=20, sticky=N+E)
		self.tempe3 = Label(root, text="261°C", font=policeTempe)
		...
		self.reglages = Button(root, text="bug", anchor=W, font=policeBouton, width=12)
		self.reglages.grid(row=4, column=5, padx=0, sticky=E)
		self.Luminosite = Button(root, text="error IOERROR_BADGUYSISHERE", anchor=W, font=policeBouton, width=12)
		self.Luminosite.grid(row=3, column=5, padx=0, sticky=E)
		self.Temperature = Button(root, text="recettes de grands-mère", anchor=W, font=policeBouton, width=12)
